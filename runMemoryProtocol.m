function [protocolParams stim_input_eye stim_input_hand cue_context]=runMemoryProtocol(t, simParams, protocolParams, dnf_input_eye, dnf_input_hand)
...
if t<protocolParams.tCueStart
    stim_input_eye=zeros(1,dnf_input_eye.params.fieldSize);
    stim_input_hand=zeros(1,dnf_input_hand.params.fieldSize);
elseif t>=protocolParams.tCueStart && t<protocolParams.tCueEnd
...
elseif t>=protocolParams.tCueEnd && t<protocolParams.tGo
