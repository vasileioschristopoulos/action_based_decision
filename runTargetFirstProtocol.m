function [protocolParams stim_input_eye stim_input_hand cue_context]=runTargetFirstProtocol(t, simParams, protocolParams, dnf_input_eye, dnf_input_hand)
...
if t<protocolParams.tStimulusStart
    stim_input_eye=zeros(1,dnf_input_eye.params.fieldSize);
    stim_input_hand=zeros(1,dnf_input_hand.params.fieldSize);
elseif t>=protocolParams.tStimulusStart && t<protocolParams.tCue
